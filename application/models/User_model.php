...
class User_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_user,username,password,stat');
        $this->datatables->from('user');
        //add this line for join
        //$this->datatables->join('table2', 'user.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('user/read/$1'),'Lihat')." | ".anchor(site_url('user/update/$1'),'Ubah')." | ".anchor(site_url('user/delete/$1'),'Hapus','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_user');
